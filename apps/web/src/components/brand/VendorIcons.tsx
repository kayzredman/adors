// Vendor-specific brand icons sourced from Simple Icons (CC0 license)
...
export function OracleIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
    ...
    >
      <title>Oracle</title>
      {/* Distinctive Oracle pill / ellipse wordmark shape */}
...
export function MssqlIcon({ size = 24, className, ...props }: IconProps) {
  // Microsoft's 4-colour brand mark — the universal identifier for all MS products
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <rect x="1"  y="1"  width="10.2" height="10.2" fill="#F25022" rx="0.5" />
      <rect x="12.8" y="1"  width="10.2" height="10.2" fill="#7FBA00" rx="0.5" />
      <rect x="1"  y="12.8" width="10.2" height="10.2" fill="#00A4EF" rx="0.5" />
      <rect x="12.8" y="12.8" width="10.2" height="10.2" fill="#FFB900" rx="0.5" />
    </svg>
  )
}

export function MariaDbIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
